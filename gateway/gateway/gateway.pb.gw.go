...
func RegisterGateWayHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GateWayServer) error {
	...
	mux.Handle("POST", pattern_GateWay_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/gateway.GateWay/Echo", runtime.WithHTTPPathPattern("/echo"))
		if err != nil {
...
func RegisterGateWayHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GateWayClient) error {
	...
	mux.Handle("POST", pattern_GateWay_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/gateway.GateWay/Echo", runtime.WithHTTPPathPattern("/echo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_GateWay_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"echo"}, ""))
)
